...
- Updated GitHub Actions workflows to utilize version 6.0.1 of the actions/checkout action, requiring migration steps for users who customized their workflows with specific version... [b290ac40](https://github.com/electrocucaracha/ai-prepare-commit-msg/commit/b290ac40527a04280263d8967c36743a290a1010)
...
- Enabled developers to generate completions that align with the LLaMA APIs requirements by updating the `completion` method in the `DummyLite` class to include parameters for temperature... [a77787c4](https://github.com/electrocucaracha/ai-prepare-commit-msg/commit/a77787c481f8e1416ebc0c3e10861428ada0052f)
...
- BREAKING: Stabilized error handling for invalid flags in the cli module to provide a single user-friendly error message improving overall robustness and usability, note that existing usage... [490d3131](https://github.com/electrocucaracha/ai-prepare-commit-msg/commit/490d31316956a82d1465d74859953e7b0ec23c1b)
